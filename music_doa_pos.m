...
numSnapshots = 30; % Number of Snapshots for which we will generate CSI
...
musicAvgWindow = floor(numSnapshots/10);
[doa_music, doaMat_music, doaMUSIC] = doa_lib.naive_music(Hest, fc, bw*1e6, rxElemPos, musicAvgWindow);
% Plot DOA from MUSIC:
...
disp(['MUSIC DoA estimated at [' num2str(doa_music) '] deg for true DoA ' num2str(beta_a) ' deg']);
