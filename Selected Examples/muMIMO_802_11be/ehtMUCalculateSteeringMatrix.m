function steeringMatBF = ehtMUCalculateSteeringMatrix(steeringMatFB,cfg,cfgNDP,ruIdx)
%ehtMUCalculateSteeringMatrix Calculate beamforming steering matrix
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   STEERINGMATBF = ehtMUCalculateSteeringMatrix(STEERINGMATFB,CFG,CFGNDP,RUIDX)
...
%
%   CFGNDP is the configuration of the EHT NDP used to gather feedback and
