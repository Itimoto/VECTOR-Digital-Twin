...
%   geometry, made up of arbitrary elements
% Here we have 4 elements. Every other element is either a dipole or monopole antenna.
...
aut = antenna.generateArbitraryAntenna(5.8e9);
positions = zeros(numAPant, 3); % Initialize element positions
for i = 1:numAPant
    positions(i, 1) = (i - (numAPant + 1) / 2) * spacing;
end

rxArray = phased.ConformalArray("ElementPosition", positions);
for i = 1:numAPant
    array.Element{i} = aut;
end
